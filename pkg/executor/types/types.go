...
// nested artifacts.
// NestedVerifierReport is generated by executor after aggregating the reports
// from different verifiers.
type NestedVerifierReport struct {
	Subject         string `json:"subject"`
	ReferenceDigest string `json:"referenceDigest"`
	ArtifactType    string `json:"artifactType"`
	// VerifierReports contains the reports from all available verifiers that
	// can verify the artifactType.
	VerifierReports []verifier.VerifierResult `json:"verifierReports"`
	// NestedReports contains the reports from all nested artifacts.
